  ...
  data() {
    return {
      ...
      menuItems: [
        ...
        { id: 2, nome: "Sou Fit", descricao:"Pão, Carne 160g, Queijo, Alface, Tomate, Picles e Maionese" ,preco: 12.00, imagem: '../cardapio/src/assets/soufit.png' },
        { id: 3, nome: "Peppa", descricao:"Pão, Carne 160g, Queijo, Bacon e Maionese" , preco: 7.00, imagem: '/cardapio/src/assets/peppa.png' },
        { id: 4, nome: "Chimichurri", descricao:"Pão, Carne 220g, Queijo, Molho Chimichurri" ,preco: 18.00, imagem: '~/assets/chimi.png' },
        { id: 5, nome: "Coca-cola Lata", preco: 18.00, imagem: '~/src/assets/coca.png' },
        { id: 6, nome: "Coca-cola s/açucar Lata", preco: 18.00, imagem: '../src/assets/coca-sacucar.png' },
        { id: 7, nome: "Chopp Pilsen 1L", preco: 18.00, imagem: '../src/assets/chopp.png' },
        { id: 8, nome: "Chopp IPA 1L", preco: 18.00, imagem: '../src/assets/chopp.png' },
        { id: 9, nome: "Água c/ gás", preco: 18.00, imagem: '../src/assets/agua-gas.png' },
        { id: 10, nome: "Água s/ gás", preco: 18.00, imagem: '../src/assets/agua.png' },
      ],
    };
  },
  computed: {
