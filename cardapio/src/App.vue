...
export default {
  data() {
    return {
      ...
      cart: [],
      menuItems: [
        { id: 1, nome: "Humildão", descricao:"Pão, Carne 160g, Queijo e Maionese + Porção de batata chips" ,preco: 28.90, imagem: '/img/humildao.png' },
        { id: 2, nome: "Sou Fit", descricao:"Pão, Carne 160g, Queijo, Alface, Tomate, Picles e Maionese + Porção de batata chips" ,preco: 30.90, imagem: '/img/soufit.png' },
        { id: 3, nome: "Peppa", descricao:"Pão, Carne 160g, Queijo, Bacon e Maionese + Porção de batata chips" , preco: 32.90, imagem: '/img/peppa.png' },
        { id: 4, nome: "Chimichurri", descricao:"Pão, Carne 220g, Queijo, Molho Chimichurri + Porção de batata chips" ,preco: 36.90, imagem: '/img/chimi.png' },
